...
LinkedIn: [linkedin.com/in/preetam-chhimpa](https://www.linkedin.com/in/preetam-chhimpa)  
CV (PDF): [resume.pdf](resume.pdf)

---

## Research interests
- Efficient multimodal learning (vision + language), especially compute- and memory-aware fusion  
...
Repo: [github.com/preetam1407/GeoAnchors](https://github.com/preetam1407/GeoAnchors)

---

### 2) Adversarial Evaluation of Vision-Language Models (Aug 2025 – Nov 2025)
Repo: [github.com/preetam1407/Adversarial-Evaluation-of-VLM](https://github.com/preetam1407/Adversarial-Evaluation-of-VLM)
...
Repo: [github.com/preetam1407/DiffGraph](https://github.com/preetam1407/DiffGraph)
...
Repo: [github.com/preetam1407/Flood-Forecasting-Model](https://github.com/preetam1407/Flood-Forecasting-Model)  
Dashboard: [flood-forecasting-system.onrender.com](https://flood-forecasting-system.onrender.com/flood-forecasting)
...
Repo: [github.com/IITGN-CS327-2024/our-own-compiler-com-piler-t6](https://github.com/IITGN-CS327-2024/our-own-compiler-com-piler-t6)
- Compiler toolchain using **Lark**, WASM backend, unit and integration testing

---

### 6) Waste Segregation System (Feb 2022 – May 2022)
Repo: [github.com/preetam1407/Waste-Segregation-using-Deep-learning](https://github.com/preetam1407/Waste-Segregation-using-Deep-learning)  
Prototype: [prototype folder](https://github.com/preetam1407/Waste-Segregation-using-Deep-learning/tree/main/prototype)
- ResNet-50 fine-tuning; **94%** validation accuracy; OpenCV + Arduino prototype

---

## Open-source (Hugging Face Transformers — BLT)
- PR: [huggingface/transformers#42685](https://github.com/huggingface/transformers/pull/42685)  
- Issue: [huggingface/transformers#42629](https://github.com/huggingface/transformers/issues/42629)  
...
Scraping and ingestion pipelines; **2.6M+** records on AWS (EC2/S3); PostgreSQL ingestion optimization.
